...
public class English_letter_test4 extends Activity implements OnClickListener{
	...
	private static  int[][] whole ={stra,strb,strc,strd,stre,strf,strg,strh,stri,strj,strk,strl,strm,strn,stro,strp,strq,strr,strs,strt,
	...
	protected void onCreate(Bundle savedInstanceState) {
        ...
        oursong = MediaPlayer.create(English_letter_test4.this, R.raw.correct_new); 
		oursong2 = MediaPlayer.create(English_letter_test4.this, R.raw.wrong_new); 
	...
	public void custom_dialog(){
        ...
        // set values for custom dialog components - text, image and button
        TextView text = (TextView) dialog.findViewById(R.id.textDialog);
        text.setText("Successfully passed");
        ImageView image = (ImageView) dialog.findViewById(R.id.imageDialog);
        ...
        Intent intent = new Intent(this,English_letter_test4.class);
