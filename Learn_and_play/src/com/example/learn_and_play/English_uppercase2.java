...
public class English_uppercase2 extends Fragment  implements OnClickListener{
	...
	public void onCreate(Bundle savedInstanceState) {
	 ...
	 @Override
	    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
	        View v = inflater.inflate(R.layout.uppercase_eng2, container,false);
			...
			vv=(ImageButton)v.findViewById(R.id.bt_vvs);
